<template>
  <q-page>
    <div class="row" v-if="videos.totalElements > 0">
      <div class="col-12">
          ...
          <q-card-actions>
            ...
            >
              ...
              <q-badge
                color="accent"
                text-color="white"
                :label="videos.totalElements"
              />
            </div>
            <q-space />
            <q-btn
              :disable="!videos.hasPrevious"
              flat
              round
              color="primary"
...
export default {
  ...
  computed: {
    ...
    videos() {
      return this.$store.getters["videos/byPageAndUserId"](
