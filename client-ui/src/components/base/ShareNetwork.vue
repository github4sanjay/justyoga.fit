<template>
  <div>
    ...
    >
      <q-icon color="white" :name="network.icon" class="q-mr-xs" />
      <span class="text-white" v-if="$q.screen.gt.xs">{{ network.name }}</span>
    </ShareNetwork>
  </div>
</template>
  ...
  data() {
    return {
      sharing: {
        ...
        hashtags: "justyoga_fit,justyogafit",
        twitterUser: "fit_justyoga"
      },
      networks: [
        // {
        //   network: "baidu",
