package com.justyoga.util.string;
...
public class StringUtil {
    ...
    //    public static String getBase64MimeForString(String str) {
    ...
    //    }
    //
    //    public static String getStringFromBase64Mime(String str) {
    //        if (str == null || str.isEmpty())
    //            return "";
    //        try {
    //            byte[] asBytes = Base64.getMimeDecoder().decode(str);
    //            return new String(asBytes, "utf-8");
    //        } catch (UnsupportedEncodingException e) {
    //            return "";
    //        }
