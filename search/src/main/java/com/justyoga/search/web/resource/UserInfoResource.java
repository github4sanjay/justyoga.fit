...
public class UserInfoResource {
    ...
    private final UserInfoUiService userInfoUiService;

    @Autowired
    public UserInfoResource(UserInfoUiService userInfoUiService) {
        this.userInfoUiService = userInfoUiService;
    }

    @GetMapping(value = "/user-info")
    @ResponseBody
    public ResponseEntity<BaseResponse<PageDTO<UserInfo>>> get(
