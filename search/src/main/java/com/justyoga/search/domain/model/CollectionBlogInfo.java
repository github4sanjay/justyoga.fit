...
@Entity
@Table(name = "collection_blog_info")
@Data
public class CollectionBlogInfo {

    @Id
    @Column(name = "id", updatable = false, columnDefinition = "BINARY(16)")
    private UUID id;

    @Column(name = "collection_id", updatable = false, columnDefinition = "BINARY(16)")
    ...
    @Column(name = "formatted_address", updatable = false)
    ...
    @Column(
            name = "administrative_area_level1_id",
            updatable = false,
            columnDefinition = "BINARY(16)")
    private UUID administrativeAreaLevel1Id;

    @Column(name = "sub_locality_level1_id", updatable = false, columnDefinition = "BINARY(16)")
    private UUID subLocalityLevel1Id;

    @Column(name = "sub_locality_level2_id", updatable = false, columnDefinition = "BINARY(16)")
    private UUID subLocalityLevel2Id;

    @Column(name = "user_rating", updatable = false)
    private Double rating = 0.0;

    @Column(name = "user_review_count", updatable = false)
    ...
    //    private String imageUrls; //Image URLs, Thumbnail is first one
    //
    //    @Type(type = "text")
    //    @Column(name = "video_urls", nullable = false)
    //    private String videoUrls;   //check for getURL function
}
