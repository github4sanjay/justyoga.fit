...
public class UserInfo {
    ...
    @Lob
    @Column(name = "cover_pic", updatable = false)
    ...
    @Type(type = "text")
    @Column(name = "user_medical_expertise", updatable = false)
    private String medicalExpertise;

    @Type(type = "text")
    @Column(name = "user_yoga_certificate", updatable = false)
    private String yogaCertificate;

    @Type(type = "text")
    @Column(name = "user_yoga_expertise", updatable = false)
    private String yogaExpertise;
