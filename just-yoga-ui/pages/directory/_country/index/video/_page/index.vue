...
export default {
  ...
  middleware: "directory_country_video",
  data: function () {
    return {
      sub: this.$store.getters["directory_videos/countryByPage"](
  ...
  computed: {
    prevTo() {
      return `/directory/${this.country}/video/${this.previousPage}`;
    },
    nextTo() {
      return `/directory/${this.country}/video/${this.nextPage}`;
    },
  },
};
</script>
