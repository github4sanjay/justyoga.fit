...
export default {
  ...
  middleware: "directory_country",
  data: function () {
    return {
      sub: this.$store.getters["directory/countryByPage"](
  ...
  computed: {
    prevTo() {
      return `/directory/${this.country}/trainer/${this.previousPage}`;
    },
    nextTo() {
      return `/directory/${this.country}/trainer/${this.nextPage}`;
    },
  },
};
</script>
