...
export default {
  ...
  middleware: "directory_locality_image",
  data: function () {
    return {
      sub: this.$store.getters["directory_images/localityByPage"](
  ...
  computed: {
    prevTo() {
      return `/directory/${this.country}/${this.state}/${this.locality}/image/${this.previousPage}`;
    },
    nextTo() {
      return `/directory/${this.country}/${this.state}/${this.locality}/image/${this.nextPage}`;
    },
  },
};
</script>
