...
export default {
  ...
  middleware: "directory_administrativeArea_video",
  data: function () {
    return {
      sub: this.$store.getters["directory_videos/administrativeAreaByPage"](
        this.$route.params.state, this.$route.params.page
      ),
  ...
  computed: {
    prevTo() {
      return `/directory/${this.country}/${this.state}/video/${this.previousPage}`;
    },
    nextTo() {
      return `/directory/${this.country}/${this.state}/video/${this.nextPage}`;
    },
  },
};
</script>
