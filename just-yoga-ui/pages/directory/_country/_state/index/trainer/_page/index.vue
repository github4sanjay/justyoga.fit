...
export default {
  ...
  middleware: "directory_administrativeArea",
  data: function () {
    return {
      sub: this.$store.getters["directory/administrativeAreaByPage"](
  ...
  computed: {
    prevTo() {
      return `/directory/${this.country}/${this.state}/trainer/${this.previousPage}`;
    },
    nextTo() {
      return `/directory/${this.country}/${this.state}/trainer/${this.nextPage}`;
    },
  },
};
</script>
