...
export default {
  ...
  middleware: "directory_administrativeArea_image",
  data: function () {
    return {
      sub: this.$store.getters["directory_images/administrativeAreaByPage"](
  ...
  computed: {
    prevTo() {
      return `/directory/${this.country}/${this.state}/image/${this.previousPage}`;
    },
    nextTo() {
      return `/directory/${this.country}/${this.state}/image/${this.nextPage}`;
    },
  },
};
</script>
